...
PASSWORD="Hsv+1896"
UNAUTH_ENDPOINT="https://esin9jp1uf.execute-api.eu-central-1.amazonaws.com/v1/open"
AUTH_ENDPOINT="https://esin9jp1uf.execute-api.eu-central-1.amazonaws.com/v1/authenticated"
...
curl ${AUTH_ENDPOINT} -H "Authorization: ${AUTH_TOKEN}"
